...
public class ExternalResources
{
    ...
    {
        final File file = DialogUtils.fileChooser(TranslatedStrings.SELECT_PYTHON_2.toString(), TranslatedStrings.PYTHON_2_EXECUTABLE.toString(), FileChooser.EVERYTHING);
    ...
    {
        final File file = DialogUtils.fileChooser(TranslatedStrings.SELECT_PYTHON_3.toString(), TranslatedStrings.PYTHON_3_EXECUTABLE.toString(), FileChooser.EVERYTHING);
    ...
    {
        final File file = DialogUtils.fileChooser(TranslatedStrings.SELECT_JAVA.toString(), TranslatedStrings.JAVA_EXECUTABLE.toString(), FileChooser.EVERYTHING);
    ...
    {
        final File file = DialogUtils.fileChooser(TranslatedStrings.SELECT_JAVAC.toString(), TranslatedStrings.JAVAC_EXECUTABLE.toString(), FileChooser.EVERYTHING);
    ...
    {
        final File file = DialogUtils.fileChooser(TranslatedStrings.SELECT_JAVA_RT.toString(), TranslatedStrings.JAVA_RT_JAR.toString(), FileChooser.EVERYTHING);
    ...
    {
        final File file = DialogUtils.fileChooser(TranslatedStrings.SELECT_JAVA_TOOLS.toString(), TranslatedStrings.JAVA_TOOLS_JAR.toString(), FileChooser.EVERYTHING);
    ...
    {
        final File file = DialogUtils.fileChooser(TranslatedStrings.SELECT_LIBRARY_FOLDER.toString(), TranslatedStrings.OPTIONAL_LIBRARY_FOLDER.toString(), FileChooser.EVERYTHING);
